...
namespace RentACar.Data.Migrations
{
    ...
    [Migration("20230314183022_UpdateRentedCars2")]
    partial class UpdateRentedCars2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentACar.Models.RentedCar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LocationReturnedId")
                        .HasColumnType("int");

                    b.Property<int>("LocationTakenId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LocationReturnedId");

                    b.HasIndex("LocationTakenId");
            ...
            modelBuilder.Entity("RentACar.Models.RentedCar", b =>
                {
                    ...
                    b.HasOne("RentACar.Models.Location", "LocationReturned")
                        .WithMany()
                        .HasForeignKey("LocationReturnedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RentACar.Models.Location", "LocationTaken")
                        .WithMany()
                        .HasForeignKey("LocationTakenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("LocationReturned");

                    b.Navigation("LocationTaken");
